------------Original Statements for the Yale Face Database--------------
...
We use the normalized yale face database (credit goes to Prof. Deb Roy, MIT Media Lab). "The location of the eyes in each image was picked manually and used to normalize the head by rotation and cropping".